...
public class BrotecitoEntity extends Animal implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);
    public BrotecitoEntity(EntityType<? extends Animal> entityTpe, Level level) {
    ...
    // Define el comportamiento de los Brotecitos en el juego
