...
public class MeicaBowAttackGoal<T extends HostileEntity & RangedAttackMob> extends Goal {
    ...
    public MeicaBowAttackGoal(T actor, double speed, int attackInterval, float range) {
        this.actor = actor;
        this.speed = speed;
    ...
    protected boolean isHoldingBow() {
        return this.actor.isHolding(ModItems.MEICA_BOW);
    }
    ...
    public void tick() {
        ...
        if (livingEntity != null) {
            ...
            if (this.actor.isUsingItem()) {
                ...
                this.actor.setCurrentHand(ProjectileUtil.getHandPossiblyHolding(this.actor, ModItems.MEICA_BOW));
            }
