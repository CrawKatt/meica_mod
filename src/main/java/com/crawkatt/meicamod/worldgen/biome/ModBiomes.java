...
public class ModBiomes {
    ...
    public static final ResourceKey<Biome> MEICADIM_FOREST = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(MeicaMod.MODID, "meicadim_forest"));
    ...
    public static void globalDimGeneration(BiomeGenerationSettings.Builder builder) {
        // Mantener lagos de agua en la superficie si es necesario
        builder.addFeature(GenerationStep.Decoration.LAKES, MiscOverworldPlacements.SPRING_WATER);
    ...
    public static Biome meicaForestDimBiome(BootstapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        spawnBuilder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.BROTECITO.get(), 5, 4, 4));
